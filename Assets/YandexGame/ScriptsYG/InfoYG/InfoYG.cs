...
namespace YG
{
    ...
    public partial class InfoYG : ScriptableObject
    {
        ...
        public class PlayerInfoSimulation
        {
            ...
            public string name = "PlayerOld this";
        ...
        public LBData[] leaderboardSimulation = new LBData[]
        {
            new LBData
            {
                ...
                players = new LBPlayerData[6]
                {
                    ...
                    new LBPlayerData { name = "PlayerOld this", rank = 5, score = 40, uniqueID = "000", photo = photoExample },
            ...
            new LBData
            {
                ...
                players = new LBPlayerData[6]
                {
                    ...
                    new LBPlayerData { name = "PlayerOld this", rank = 5, score = 127000, uniqueID = "000", photo = photoExample },
        ...
        {
            [InspectorName("PlayerOld Settings")] unity,
